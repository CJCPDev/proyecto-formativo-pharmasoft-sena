...
# Registro de los modelos del módulo de medicamentos en el panel de administración de Django.
# Cada clase Admin personaliza cómo se visualiza y gestiona cada modelo en el admin.
