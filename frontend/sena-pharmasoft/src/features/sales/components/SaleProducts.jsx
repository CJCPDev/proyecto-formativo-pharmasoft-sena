...
export default function SaleProducts() {
  ...
  return (
    <div className="bg-white grid gap-2 w-full h-full p-6 rounded-lg font-main">
      <div>
        <Title title="Descripcion de productos"></Title>
        <div className="grid grid-cols-6 w-full text-center bg-brand-hover ">
          <span className="border border-l border-gray-200 text-white">
            Producto
          </span>
          <span className="border border-l border-gray-200 text-white">
            Cantidad
        ...
        <div className="grid grid-cols-4 gap-4 mx-auto">
          <div className="col-span-2  mx-auto">
            <Input disabled label="Subtotal" />
          </div>
          <div className="col-span-2 mx-auto">
            <Input disabled label="Iva" placeholder="Iva" />
          </div>
          <div className="col-span-4  mx-auto">
            <Input disabled label="Total Venta" placeholder="Total Venta" />
          </div>
        </div>
