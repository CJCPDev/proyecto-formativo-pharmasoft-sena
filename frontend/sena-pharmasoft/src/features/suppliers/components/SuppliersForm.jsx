...
export default function SuppliersForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data?.nit) setServerError("Ya existe un proveedor con este NIT.");
        ...
        setServerError("Ya existe un proveedor con esta Razón Social.");
      else
        setServerError(
          "Error al guardar el proveedor. Probablemente existe uno con los mismos datos.",
        );
      setShowModal(true);
    }
  };
  ...
  return (
    <div>
      ...
      >
        {isEdit ? (
          <Title title="Editar proveedor" />
        ) : (
          <Title title="Crear proveedor" />
        )}
