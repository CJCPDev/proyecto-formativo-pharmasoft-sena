...
import { supplierReportFields } from "../config/supplierReportFields.js";

// Caso de uso que orquesta la generación del reporte
import { generateSupplierReport } from "../services/generateSupplierReport.js";
...
export default function ReportConfigModal({ isOpen, onClose }) {
  ...
  const [selectedFields, setSelectedFields] = useState(
    () => supplierReportFields.filter((f) => f.default), // Solo campos marcados por defecto
  );
