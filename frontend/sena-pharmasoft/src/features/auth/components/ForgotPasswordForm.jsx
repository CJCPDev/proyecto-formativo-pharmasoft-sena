            ...
            <div className="bg-white w-102 p-6 rounded-lg shadow-2xl">
                <form >
                    <div className="grid text-main justify-items-center text-main">
                        ...
                        <p className="text-secondary text-info-general text-center font-semibold py-6">Por favor ingrese el correo electrónico registrado para restablecer la contraseña.</p>
                    </div>
